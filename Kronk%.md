...
Originally based on https://drop.rixx.de/JjBs by Rixxian, reroutes by Ff300, many more reroutes by Rekcah
...
* Grab rafters seal and sell to Lemm (hit lever) {1420} (10)
* Head through DLC rooms to Sanctum, getting both mandatory levers (11+12)
* Fight Soul Warrior {1630} (13)
...
* Enter the reward room for another lever, then immediately benchwarp (44)
* Kill Dung Defender and get lever (45)

### Monarch Wings

* Go through spike tunnel to get stepped upon (Emilitia) (46)
...
* \[2D] Bench at resting grounds stag then stag to Dirtmouth
* Cdash to peak elevator and hit lever, then cdash left to KP (47)
* Go to Gorb, kill Gorb and collect essence, benchwarp
...
* \[3D] Stag to Resting Grounds Station and bench there
* \[2U] Stag to Greenpath, go down and hit lever (50)
* Continue left and down to enter Queen's Gardens through wraiths entrance shade gate
...
* QG stag lever (54)
* Dreamgate back (optionally benchwarp for HP before dgate)
...
* Benchwarp to Resting Grounds Station (no need to collect tram pass)

### Enter White Palace

* Remove Shaman, equip Wielder, HIT BELL
* Get enough essence from resting grounds root (2-3 depending on essence drop RNG) until 1800
